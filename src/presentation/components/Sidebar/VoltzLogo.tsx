...
export function VoltzLogo({
  className,
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  collapsed,
  ...props
}: React.SVGProps<SVGSVGElement> & { collapsed?: boolean }) {
  return (
    <svg
      viewBox="0 0 34 32"
      fill="none"
    ...
    >
      {/* 
        Professional Bucket Icon
        - 3 Stacked strokes with variable width (tapering) to imply motion/energy 
        - Curved to resemble a container/bucket profile
      */}
      <path
